...
export default function Cta() {
  const stats = [
    { value: "500+", label: "Implementations", icon: TrendingUp },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join hundreds of enterprises who have transformed their operations with our proven SAP ERP solutions. 
                Start your journey with a complimentary business assessment.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Comprehensive business analysis at no cost
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Industry-leading implementation approach
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Fast-track implementation in 6-12 months
              </p>
            </div>
          </div>
        </div>
